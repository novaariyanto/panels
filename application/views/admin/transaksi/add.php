   ...
   <div class="container-fluid page-body-wrapper">
        ...
        <?php $this->load->view('layouts/navigasi_admin',['menu'=>'transaksi']) ?>
        <!-- partial -->
                ...
                <div class="card">
                  ...
                  <form class="forms-sample" method="post" action="">
                      ...
                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Package <br> <span style="color:red"> <?=form_error('package')?> </span></label>
                        <div class="col-sm-9">
                          <select name="package" id="" class="form-control">
                            ...
                            foreach ($packages as $value){
                              ?> <option value="<?=$value->id;?>"><?=$value->name."(".rupiah($value->price).")"?></option><?php
                            }
