   ...
   <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <a href="<?=base_url('/index.php/package/add')?>" class="btn btn-sm btn-primary" style="margin-top:-35px;margin-right:-4px" >Add </a>
                      ...
                      <tbody>
                        ...
                        $page2 = (int)$page + 1;
                          ...
                          foreach ($devices as $value) {
                              ...
                              $option_btn = '<a class="btn btn-sm btn-danger" href="'.base_url("/index.php/package/delete/$value->id").'">Delete</a>  <a class="btn btn-sm btn-info" href="'.base_url("/index.php/package/edit/$value->id").'">Edit</a>';
                              echo '<tr>
                          <td>'.$i.'</td>
                          <td>'.$value->name.'</td>
                          <td>'.rupiah($value->price).'</td>
                          <td> '.$value->device_max.'</td>
                          <td>'. $status_show.'</td>
                          <td>'.$value->day_value.'</td>
                          <td>'. $option_btn.'</td>
                        </tr>';
                          } ?>
