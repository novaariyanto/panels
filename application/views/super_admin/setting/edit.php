                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="">
                      ...
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">Client Key ( Midtrans )<br> <span style="color:red"><?= form_error('client_key') ?></span></label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="client_key" id="exampleInputMobile" placeholder="SB-Mid-client-G699eb4x0NgQLdEL" value="<?=$setting->client_key ?>">
                      ...
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">Server  Key ( Midtrans )<br> <span style="color:red"><?= form_error('server_key') ?></span></label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="server_key" id="exampleInputMobile" placeholder="SB-Mid-server-RH4S3FpXeevCsj6M5hNbWf5k" value="<?=$setting->server_key ?>">
                      ...
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">IsProduction<br> <span style="color:red"><?= form_error('isProduction') ?></span></label>
                        <div class="col-sm-9">
                        <select name="isProduction" class="form-control" id="">
                          <option <?=($setting->isProduction == "1" ? 'selected':'') ?> value="1">True</option>
                          <option <?=($setting->isProduction == "0" ? 'selected':'') ?> value="0">False</option>
                        </select>  
