                ...
                <div class="card">
                  ...
                  <form class="forms-sample" method="post" action="">
                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nomor <br> <span style="color:red"> <?= form_error('nomor') ?> <?php echo $this->session->flashdata('message_add_device_error'); ?></span></label>
                        <div class="col-sm-9">
