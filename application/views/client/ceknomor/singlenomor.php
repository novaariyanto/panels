   ...
   <div class="container-fluid page-body-wrapper">
        ...
        <?php $this->load->view('layouts/navigasi',['menu'=>'singlenomor']) ?>
        <!-- partial -->
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  ...
                  <form class="forms-sample" method="post" action="">
                      ...
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nomor <br> <span style="color:red"><?php echo $this->session->flashdata('message_add_device_error'); ?></span></label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  name="nomor" id="exampleInputUsername2" placeholder="ex : 08753610348xx" value="">
