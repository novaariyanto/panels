...
<html lang="en">
  <head>
    ...
    <title>Dompul Otomatisasi| by Whatsva</title>
    <!-- plugins:css -->
      ...
      <div class="container-fluid page-body-wrapper full-page-wrapper">
		...
		<?php endif?>
            <form class="pt-3" action="" method="post">
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-lg" name="phone_number" id="exampleInputEmail1" placeholder="Phone Number" required>
                    <div class="invalid-feedback">
